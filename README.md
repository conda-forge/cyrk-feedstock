...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cyrk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cyrk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=23957&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cyrk-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314t" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
It is possible to list all of the versions of `cyrk` available on your platform:
...
```
pixi search cyrk --channel conda-forge
```
